...
def decrypt():
    ...
    if password=="1234":
        ...
        Label(screen2, text="DECRYPT", font="arial", bg="#00bd56").place(x=10, y=10)
...
def encrypt():
    ...
    if password=="1234":
        ...
        Label(screen1, text="ENCRYPT", font="arial", bg="#ed3833").place(x=10, y=10)
...
def main_screen():
    ...
    Label(text="Enter secret key for encryption and decryption", fg="black", 
